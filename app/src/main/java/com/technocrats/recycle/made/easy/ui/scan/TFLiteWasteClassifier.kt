...
class TFLiteWasteClassifier(private val context: Context) {
    ...
    private fun initializeInterpreter(){
        ...
        modelInputSize = FLOAT_TYPE_SIZE * inputImageHeight * inputImageWidth * CHANNEL_SIZE
